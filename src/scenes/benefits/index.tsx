...
const container = {
  hidden: {},
  visible: {
    transition: { staggerChildren: 0.166 },
  },
}
    ...
    <section id="benefits" className="mx-auto min-h-full w-5/6 pt-32 pb-16">
      ...
      >
        ...
        <motion.div
          ...
          variants={container}
        >
          {benefits.map((benefit: BenefitType, idx: number) => (
            <Benefit
        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
          ...
          <div>
            ...
            <div className="relative">
              <div className=" before:-bottom-16 before:right-20 before:z-[-1] before:content-sparkles">
